<%-- 
    ...
    Created on : 23/02/2017, 11:41:17 PM
    Author     : franc
--%>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            ...
                            <div id="mainContent" role="tabpanel" class="tab-pane active">
                                ...
                                <br>
                                <form name="form1" action="<%=context%>/buscarCliente">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <s:iterator value="misResultados" status="stet"> 
                                            <tr>
                                                <input name="idCliente" type="hidden" value="<s:property value="idCliente"/>"/>
                                        ...
                                        <div class="container">
                                            <td> <a href="<%=context%>/cargarDatosCliente?idCliente=<s:property value="idCliente"/>" class="btn btn-warning">Modificar</a></td>                                                      
                                        </div>        
                                        </tr>
                                    </s:iterator> 
                                    </tbody>
