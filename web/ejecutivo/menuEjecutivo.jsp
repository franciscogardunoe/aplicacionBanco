                        ...
                        <div class="tab-content">
                            ...
                            <div id="mainContent" role="tabpanel" class="tab-pane active">
                                ...
                                <form name="form1" action="">
                                    <input name="UnEjecutivo.idEjecutivo" hidden="" value="<s:property value="UnEjecutivo.idEjecutivo"/>" readonly/>
                                    <div class="form-group">
                                        <label for="ic">Nombre:</label>
                                        <input name="UnEjecutivo.nombre" hidden="" class="form-control" value="<s:property value="UnEjecutivo.nombre"/>"readonly/>
                                    </div>  
                                    <div class="form-group">
                                        <label for="nc">Apellidos:</label>
                                        <input name="UnEjecutivo.apellidos" hidden="" class="form-control" value="<s:property value="UnEjecutivo.apellidos"/>"readonly/>
                                    </div>  
                                    <div class="form-group">
                                        <label for="nnc">Fecha de nacimiento:</label>
                                        <input name="UnEjecutivo.fechaNacimiento" hidden="" class="form-control" value="<s:property value="UnEjecutivo.fechaNacimiento"/>"readonly/>
                                    </div>     
                                    <div class="form-group">
                                        <label for="nnc">Dirección:</label>
                                        <input name="UnEjecutivo.direccion" hidden="" class="form-control" value="<s:property value="UnEjecutivo.direccion"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Teléfono:</label>
                                        <input name="UnEjecutivo.telefono" hidden="" class="form-control" value="<s:property value="UnEjecutivo.telefono"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Sueldo:</label>
                                        <input name="UnEjecutivo.sueldo" hidden="" class="form-control" value="$ <s:property value="UnEjecutivo.sueldo"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Número de Seguridad Social:</label>
                                        <input name="UnEjecutivo.nss" hidden="" class="form-control" value="<s:property value="UnEjecutivo.nss"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">RFC:</label>
                                        <input name="UnEjecutivo.rfc" hidden="" class="form-control" value="<s:property value="UnEjecutivo.rfc"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Correo electrónico:</label>
                                        <input name="UnEjecutivo.usuario.correoElectronico" hidden="" class="form-control" value="<s:property value="UnEjecutivo.usuario.correoElectronico"/>"readonly/>
                                    </div>                   
                                </form>
                            </div>                          
                        </div>
