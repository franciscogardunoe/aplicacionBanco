<%-- 
    ...
    Created on : 19/02/2017, 05:39:23 PM
    Author     : franc
--%>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="mainContent" role="tabpanel" class="tab-pane active">
                                ...
                                <form name="form1" action="">
                                    <input name="unCliente.idCliente" hidden="" value="<s:property value="UnCliente.idCliente"/>" readonly/>
                                    <div class="form-group">
                                        <label for="ic">Nombre:</label>
                                        <input name="unCliente.nombre" hidden="" class="form-control" value="<s:property value="UnCliente.nombre"/>"readonly/>
                                    </div>  
                                    <div class="form-group">
                                        <label for="nc">Apellidos:</label>
                                        <input name="unCliente.apellidos" hidden="" class="form-control" value="<s:property value="UnCliente.apellidos"/>"readonly/>
                                    </div>  
                                    <div class="form-group">
                                        <label for="nnc">Fecha de nacimiento:</label>
                                        <input name="unCliente.fechaNacimiento" hidden="" class="form-control" value="<s:property value="unCliente.fechaNacimiento"/>"readonly/>
                                    </div>     
                                    <div class="form-group">
                                        <label for="nnc">Dirección:</label>
                                        <input name="unCliente.direccion" hidden="" class="form-control" value="<s:property value="UnCliente.direccion"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Teléfono:</label>
                                        <input name="unCliente.telefono" hidden="" class="form-control" value="<s:property value="UnCliente.telefono"/>"readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nnc">Correo electrónico:</label>
                                        <input name="UnCliente.usuario.correoElectronico" hidden="" class="form-control" value="<s:property value="UnCliente.usuario.correoElectronico"/>"readonly/>
                                    </div>                   
                                </form>
